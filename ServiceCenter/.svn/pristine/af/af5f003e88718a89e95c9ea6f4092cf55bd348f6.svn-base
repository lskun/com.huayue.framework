...
(function (b) {
    ...
    { version: "1.8.7" }); b.ui.plugin.add("resizable", "alsoResize", {
        start: function () {
...
jQuery.effects || function (b, c) {
    ...
    o) {
        ...
        version: "1.8.7", save: function (l, k) { for (var m = 0; m < k.length; m++) k[m] !== null && l.data("ec.storage." + k[m], l[0].style[k[m]]) }, restore: function (l, k) { for (var m = 0; m < k.length; m++) k[m] !== null && l.css(k[m], l.data("ec.storage." + k[m])) }, setMode: function (l, k) {
...
(function (b, c) {
    ...
    } b.extend(b.ui, { datepicker: { version: "1.8.7" } }); var e = (new Date).getTime(); b.extend(f.prototype, {
...
(function (b, c) {
    ...
    }); b.extend(b.ui.dialog, { version: "1.8.7", uuid: 0, maxZ: 0, getTitleId: function (e) { e = e.attr("id"); if (!e) { this.uuid += 1; e = this.uuid } return "ui-dialog-title-" + e }, overlay: function (e) { this.$el = b.ui.dialog.overlay.create(e) } }); b.extend(b.ui.dialog.overlay, {
...
(function (b, c) {
    ...
    }); b.extend(b.ui.tabs, { version: "1.8.7" }); b.extend(b.ui.tabs.prototype, {
