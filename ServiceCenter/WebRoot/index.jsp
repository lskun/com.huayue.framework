	 ...
	 var _menus = {"menus":[
	 					{"menuid":"28","icon":"icon-sys","menuname":"考勤管理",
							"menus":[{"menuid":"41","menuname":"员工信息","icon":"icon-nav","url":"/view/all_userinfo.jsp"},
									{"menuid":"42","menuname":"请假/公出申请","icon":"icon-nav","url":"/view/extraleave.jsp"},
									...
									{"menuid":"46","menuname":"个人考勤明细","icon":"icon-nav","url":"/attend/req.do"},
									{"menuid":"47","menuname":"个人考勤统计","icon":"icon-nav","url":"/attend/personalAttend.do"},																		
									{"menuid":"48","menuname":"个人加班统计","icon":"icon-nav","url":"/extra/overWork.do"},
									{"menuid":"49","menuname":"加班统计列表","icon":"icon-nav","url":"/extra/totalOverWork.do"},									
									{"menuid":"50","menuname":"全体考勤统计","icon":"icon-nav","url":"/attend/allAttend.do"}
								]
						},
        ...
        function serverLogin() {
            ...
            $.post('/servlet/EditPassword?newpass=' + $newpass.val() + '&id=' + <%=user.getId()%>, function(msg) {
