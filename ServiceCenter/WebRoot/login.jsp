            ...
            <tr>
              ...
              <td height="21"><table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table211" height="328">
                  <tr>
					...
					<form name="myform" action="/user/login.do" method="post">
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0" height="143" id="table212">
                          <tr>
                            <td width="13%" height="38" class="top_hui_text"><span class="login_txt">管理员：&nbsp;&nbsp; </span></td>
                            <td height="38" colspan="2" class="top_hui_text" style="text-align:left;padding:0;margin:0"><input name="name" class="editbox4" value="" size="20"></td>
                          </tr>
                          <tr>
                            <td width="13%" height="35" class="top_hui_text"><span class="login_txt"> 密 码： &nbsp;&nbsp; </span></td>
                            <td height="35" colspan="2" class="top_hui_text" style="text-align:left;padding:0;margin:0"><input class="editbox4" type="password" size="20" name="password">
                              <img src="../images/luck.gif" width="19" height="18" >
                              &nbsp;&nbsp;<% if(request.getAttribute("error_message") != null) out.println("错误提示 ：<span style='color:red'>" + request.getAttribute("error_message") + "</span>"); %>  
                            </td>
                          </tr>
						  <!--
                          <tr>
                          ...
                          <tr>
                            <td height="35" >&nbsp;</td>
                            <td width="20%" height="35"  style="text-align:left;padding:0;margin:0"><input name="Submit" type="submit" class="button" id="Submit" value="登 陆"> </td>
                            <td width="67%" class="top_hui_text" style="text-align:left;padding:0;margin:0"><input name="cs" type="button" class="button" id="cs" value="取 消" onClick="showConfirmMsg1()"></td>
                          </tr>
                        </table>
                        <br>
                    </form></td>
